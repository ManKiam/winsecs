...
class OpenSSHForWindows:
    # key_files_location = os.path.join(constant.profile["USERPROFILE"], u'.ssh')
    ...
    #         log.error(u"Cannot validate key protection '%s'" % e)
    #         state = False
    #         pass
    #
    #     return state
                ...
                for f in filenames:
                    ...
                    if os.path.isfile(key_file_path):
                        try:
                            ...
                            log.error("Cannot load key file '%s' '%s'" % (key_file_path, e))
                            pass
    ...
    def run(self, profile):
        ...
        Main function
        """
        self.key_files_location = os.path.join(profile["USERPROFILE"], '.ssh')
        # Extract all DSA/RSA private keys that are not protected with a passphrase
        ...
        return list(key_found)


modules = {"OpenSSHForWindows": OpenSSHForWindows()}
